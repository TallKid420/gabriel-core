...
into a `.env` file at the repository root and adjust as needed. The API auto-loads
that file at startup for local development; shell environment variables still take
precedence when already set.
