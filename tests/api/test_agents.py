...
def test_agent_list_returns_empty_list_for_authenticated_user_with_no_agents(client, auth_headers):
	other_headers = {
		"Authorization": "Bearer principal://initech/user/sam",
...
def test_agent_list_does_not_cross_tenants(client, auth_headers):
	create_response = client.post(
		"/agents",
	...
	other_headers = {
		"Authorization": "Bearer principal://globex/user/bob",
		"X-Capabilities": "read_resource,write_resource,execute_workflow",
